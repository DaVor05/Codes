...
public class ProyectoAlgoritmosOrdenamiento {
        ...
        while (true) {
            ...
            switch (opcion) {
                ...
                while (!volverMenuPrincipalBusqueda) {
                    ...
                    System.out.println("[3] Busqueda HashMap");
                    ...
                    switch (opcionBusqueda) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            System.out.println("Busqueda HashMap:"); 
                            HashMap(args);
                            break;     
                        case 4:
    ...
    public static void BusBina (String[] args) {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void BusSec(String[] args) {
        Scanner scanner = new Scanner(System.in);

        // Crear un arreglo con 10 productos
        Producto4[] productos = {
            new Producto4("Laptop", 0),
            new Producto4("Mouse", 1),
            new Producto4("Teclado", 2),
            new Producto4("Monitor", 3),
            new Producto4("CPU", 4),
            new Producto4("Impresora", 5),
            new Producto4("Auriculares", 6),
            new Producto4("Cámara", 7),
            new Producto4("Disco Duro", 8),
            new Producto4("USB", 9)
        };
        ...
        buscarProductoPorCodigo(productos, codigo);
    }

    // Método para buscar un producto por su código
    public static void buscarProductoPorCodigo(Producto4[] productos, int codigo) {
        for (Producto4 producto : productos) {
    ...
    //Codigo de Busqueda HashMap - Ultimo codigo de proyecto
    public static void HashMap (String[] args) {
        ...
        //Los valores al HashMap
        directorio.put("David", "663-156-4811");
        directorio.put("Derian", "664-830-8959");
        directorio.put("Cristian", "663-333-4194");
        directorio.put("Andreas", "663-150-9912");
        directorio.put("Giovanni", "664-666-1211");
        directorio.put("Yahir", "664-555-9119");
        directorio.put("Brandon", "664-697-6208");
        directorio.put("Adrian", "664-299-2007");
        directorio.put("Mya", "663-333-4435");
        directorio.put("Jose Luis", "664-299-9207");

        Scanner scanner = new Scanner(System.in);

        System.out.println("Escribe el nombre de la persona para buscar su número:");
        String NombreBuscar = scanner.nextLine();

        if (directorio.containsKey(NombreBuscar)) {
            System.out.println("El número de " + NombreBuscar + " es: " + directorio.get(NombreBuscar));
        } else {
            System.out.println(NombreBuscar + " no se encuentra en el directorio.");
        }
    }
